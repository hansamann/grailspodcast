	   		...
	   		<!-- body -->
	      		...
	      		<div class="yui-b">
					...
					<div class="defaultContainer">
                        ...
                        <a href="http://feeds.grailspodcast.com/grailspodcast"><img src="http://feeds.feedburner.com/~fc/grailspodcast?bg=000000&fg=FFFFFF&anim=1&label=listeners" height="26" width="88" style="border:0" alt="" /></a>
					</div>					
					
	      			<div class="section topSpace">about</div>
	      			<div class="defaultContainer">
	      			The Grails Podcast is a bi-weekly podcast about the <a href="http://groovy.codehaus.org">Groovy</a> scripting language, the <a href="http://www.grails.org">Grails</a> 
